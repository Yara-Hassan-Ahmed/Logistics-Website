...
if(isset($_POST["submit"])){
    ...
    if($_FILES["image"]["error"] == 4){
      ...
      if ( !in_array($imageExtension, $validImageExtension) ){
        ...
        $query = "INSERT INTO document VALUES('', '$name','$par','$newImageName')";
...
?>
    ...
    <div class="form">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <label>Document title</label>&nbsp;&nbsp;<input type="text" name="nam" id="nam"><br><br> 
            <label>Paragraph</label><br><br>&nbsp;&nbsp;<textarea name="par" id="par" cols="50" rows="10"></textarea> <br><br> 
            <label>Document</label>&nbsp;&nbsp;<input type="file" name="image" id="image" ><br><br> 
