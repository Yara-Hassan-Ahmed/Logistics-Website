...
<script>
    ...
    <div class="bg-image">
        <img src = "0000.jfif"style = "width:100%;"height = "600"></div>
            <div class ="top-left">CHARTERING</div>
        
    <div class ="main">
        
        <div class = "Chartering">
                ...
                <p>
                    Chartering activities comes to be our main activity. Chartering for breakbulk in Egypt is a 
                    rare service because of the need of having experience for hiring a suitable vessel.
                    Ocean Blue Shipping has experience to set up suitable contracts between their clients and ship owners.
                </p>
            </div>
            <img src="Chartering.png" style="position: relative; left: 30%; height: 340px;">
