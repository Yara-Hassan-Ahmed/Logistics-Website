...
<body>
    ...
    <img src = "0000.jfif"style = "width:100%;"height = "600"></div>
        <div class ="top-left">SHIPPING AGENCY</div>
    
<div class ="main">
    
    <div class = "Shipping-Agency">
                ...
                <div class = "text">
                    ...
                    <p>Ocean Blue shipping is an Egyptian shipping agent authorized in all 
                        Egyptian ports serving all types of vessels up to 25000 tons 
                        registered tonnage. We provide agency services for breakbulk and general cargoes vessels
                        arriving or departuring Egypt.
                    </p>
                </div>

                <img src="ship_agency_icon.png" >
